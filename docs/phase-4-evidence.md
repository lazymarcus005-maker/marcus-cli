...
Focused verification under Node.js 24.21.0 passes; the full suite currently passes 153 tests. Typecheck, build and CLI help/version smoke checks pass. Live endpoint and cross-platform gates still remain.
