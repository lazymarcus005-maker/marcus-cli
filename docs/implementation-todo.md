...
Implement the approved GitHub tickets in dependency order. Ticket numbers refer to `lazymarcus005-maker/marcus-cli`.

- [x] #1 Bootstrap runnable Macus CLI and Pi compatibility adapter
- [x] #2 Trusted model profiles and streaming sessions
...
- [x] #10 Bounded repository map and retrieval exclusions
- [x] #11 Working set, context tiers, and deterministic selection
- [x] #12 Request manifests and detailed context inspection
- [x] #13 Durable tasks and bounded coding workflow
- [x] #14 Git context, diff attribution, and change-aware retrieval
- [x] #15 Test evidence, bounded fix loop, and review output
