...
- Current full suite passes on Node.js 24.21.0 (153 tests); typecheck and build pass on the current implementation snapshot. This is not a phase sign-off because the open gate items below remain.
