...
- Build and tests: `npm test` (146 passed, 0 failed), `npm run typecheck`, and `npm run build` passed with Node.js 24.21.0 on macOS arm64 on 2026-09-19. The same checks were rerun in the Linux arm64 container against commit `73b6ba6` below.
